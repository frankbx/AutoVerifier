...
class SerialToolUI(object):
    ...
    def create_frm_left(self):
        ...
        self.create_frm_left_serial_settings()

    def create_frm_left_serial_settings(self):
        '''
        串口配置，比如波特率，奇偶校验等
        '''
        ...
        self.frm_left_combobox_baudrate.current(5)
    ...
    def create_frm_right(self):
        '''
        Upper right part of the frame, put buttons present key press
        '''
        self.frm_right_reset = pytk.PyLabelFrame(self.frm_right)
        self.frm_right_buttons = pytk.PyLabelFrame(self.frm_right)
        ...
        self.frm_right_buttons.grid(row=1, column=0, padx=1, sticky="wesn")
        self.frm_right_clear.grid(row=2, column=0, padx=1, sticky="wesn")
        self.frm_right_receive.grid(row=3, column=0, padx=1, sticky="wesn")
        # self.frm_right_receive.insert(INSERT,"hello"+'\n')
        # self.frm_right_receive.insert(INSERT,"world\n")
        # self.frm_right_receive.tag_config("green", foreground="#228B22")
        self.create_frm_right_reset()
        self.create_frm_right_buttons()

    def create_frm_right_buttons(self):
        # self.comm_wheel_turn_btn = pytk.PyButton(self.frm_right_buttons,
        #                                          text="CommWheel Left Turn",
        #                                          width=15,
        #                                          font=("Monaco", 8),
        #                                          command=self.callback)
        # self.comm_wheel_turn_btn.bind('<Button-1>', self.callback)  # , value='KEY_ACTION_COMWHEEL_LEFT_TURN')
        # self.comm_wheel_turn_btn.grid(row=0, column=0, padx=5, pady=5, sticky="wesn")
        pass
    ...
    def create_frm_right_reset(self):
        ...
        self.frm_right_reset_label = pytk.PyLabel(self.frm_right_reset,
                                                  text="Buttons" + " " * size_dict["reset_label_width"],
                                                  font=font)
...
if __name__ == '__main__':
    ...
    root.title("Auto Verifier Script-Tool")
